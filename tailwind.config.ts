  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'elevation-1-inverted': '0 -1px 2px hsl(var(--color-elevation-layer-1)), 0 -1px 8px hsl(var(--color-elevation-layer-2))',
        'elevation-2': '0 2px 4px 0 hsl(var(--color-elevation-layer-1)), 0 0 12px 0 hsl(var(--color-elevation-layer-2))',
        'elevation-2-inverted': '0 -2px 4px 0 hsl(var(--color-elevation-layer-1)), 0 0 12px 0 hsl(var(--color-elevation-layer-2))',
